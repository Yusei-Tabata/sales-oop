        ...
        <div class="h-100 d-flex justify-content-center align-items-center">
            <div class=" w-50 mx-auto">
                <div class="header bg-white border-0 my-5 ">
                    <h1 class="text-center text-success bg-light" style="font-size: 85px;"><i class="fa-solid fa-hand-holding-dollar"></i> Payment</h1>
                </div>
                <div class="w-75 mx-auto">
                    <form action="../actions/buy-product.php" method="POST">
                        ...
                        <div class="row mb-5">
                            <div class="col">
                                <label for="price" class="form-label fw-bold text-secondary">Total Price</label>
                                <h1 name="price" id="price" class="fw-bold">$ <?= $product['price'] ?></h1>
                            </div>
                            <div class="col">
                                <label for="quantity" class="form-label fw-bold text-secondary">Buy Quantity <span class="text-danger">*</span></label>
                                <h1 name="stock" id="stock" class="fw-bold"><?= $product['quantity'] ?></h1>
                                <small class="text-danger">The maximum is 100</small>
                            </div>
                        </div>
                        <div class="row mb-5">
                                <label for="quantity" class="form-label fw-bold text-secondary">Payment</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-secondary me-0 h1">$</span>
                                    <input type="number" name="buy_quantity" id="quantity" class="fw-bold h1 w-75">
                                </div>
                        </div>
